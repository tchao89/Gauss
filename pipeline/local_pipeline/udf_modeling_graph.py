...
class UdfModelingGraph(BaseModelingGraph):
    ...
    def __init__(self, name: str, **params):
        ...
        """
        self.init__ = super().__init__(name=name, metric_eval_used_flag=params[ConstantValues.metric_eval_used_flag],

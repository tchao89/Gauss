...
class UdfModelingGraph(BaseModelingGraph):
    ...
    def _run_route(self, **params):
        ...
        preprocess_chain = PreprocessRoute(
            ...
            weight_column_name=self._global_values["weight_column_name"],
        ...
        core_chain = CoreRoute(
            ...
            model_name=params.get(ConstantValues.model_name),
            init_model_path=self._work_paths["init_model_path"],
            ...
            supervised_selector_mode=self._global_values["supervised_selector_mode"],
            improved_supervised_selector_name=self._component_names["improved_supervised_feature_selector_name"],
            improved_selector_configure_path=self._work_paths["improved_selector_configure_path"],
            feature_model_trial=self._global_values["feature_model_trial"],

...
def config_v0_to_v1(config: dict) -> dict:
    if 'clusterMetaData' not in config:
        ...
        if experiment_config['trainingServicePlatform'] == 'hybrid':
            ...
            inverse_config = _inverse_cluster_metadata(experiment_config['trainingServicePlatform'],
                                                       experiment_config['clusterMetaData'])
            experiment_config.update(inverse_config)
...
class Experiments:
    ...
    def __init__(self, home_dir=NNI_HOME_DIR):
        ...
        # example: {experiment_file: /home/liangqian/nni-experiments/.experiment}
    ...
    def read_file(self):
        ...
        if os.path.exists(self.experiment_file):
            # self.experiment_file/home/liangqian/: nni-experiments/.experiment
            try:

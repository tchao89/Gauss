...
# 数据清洗组件
clear_params = Bunch(name='clean', train_flag=True, enable=True, model_name="tree_model", feature_configure_path="/home/liangqian/PycharmProjects/Gauss/test/factory_test/final_configure.yaml", strategy_dict=None)

...
test_clean = PlainDataClear(name='clean', train_flag=True, enable=True, model_name="tree_model", feature_configure_path='/configure_files/final_configure.yaml', strategy_dict=None)

...
from .. import pyll
from core.core_tuning.hyperopt.pyll import scope

from core.core_tuning.hyperopt import Trials

from core.core_tuning.hyperopt.base import miscs_to_idxs_vals, STATUS_OK

from core.core_tuning.hyperopt import hp

from core.core_tuning.hyperopt.tpe import adaptive_parzen_normal_orig
from core.core_tuning.hyperopt.tpe import GMM1
from core.core_tuning.hyperopt.tpe import GMM1_lpdf
from core.core_tuning.hyperopt.tpe import LGMM1
from core.core_tuning.hyperopt.tpe import LGMM1_lpdf

import core.core_tuning.hyperopt.rand as rand
from ... import hyperopt as tpe
from core.core_tuning.hyperopt import fmin
...
class TestOptQUniform(object):
    ...
    def work(self, **kwargs):
        ...
        fmin(passthrough,
             ...
             max_evals=self.LEN)
        if self.show_vars:
            core.hyperopt.plotting.main_plot_vars(trials, bandit, do_show=1)
        ...
        from core.core_tuning.hyperopt.tpe import ap_filter_trials
        from core.core_tuning.hyperopt.tpe import adaptive_parzen_samplers

...
import numpy as np
import unittest
from core.core_tuning.hyperopt import hp, Trials, fmin, tpe
from core.core_tuning.hyperopt import anneal, rand
...
class TestPChoice(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        for i in range(0, 1000):
            nesto = core.hyperopt.pyll.stochastic.sample(space, rng=rng)
            if nesto == 'gaussian':
                a += 1

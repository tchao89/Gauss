...
class TrialsInfo:
    """
    Information of each trial from one model inference
    """
...
class PPOTuner(Tuner):
    ...
    def update_search_space(self, search_space):
        ...
        self.actions_spaces, self.actions_to_config, self.full_act_space, obs_space, nsteps = self._process_nas_space(
            search_space)
    ...
    def generate_parameters(self, parameter_id, **kwargs):
        ...
        **kwargs
        ...
        if self.first_inf:
            ...
            mb_obs, mb_actions, mb_values, mb_neglogpacs, mb_dones, last_values = self.model.inference(
                self.inf_batch_size)

...
def json2space(x, oldy=None, name=NodeType.ROOT):
    """
    Change search space from json format to hyperopt_example format
...
class ClassArgsValidator(object):
    """
    NNI tuners/assessors/advisors accept a `classArgs` parameter in experiment configuration file.
    This ClassArgsValidator interface is used to validate the classArgs section in experiment
    configuration file.
    """

...
from core.featuretools.entityset.deserialize import \
    description_to_entityset as deserialize_es
from core.featuretools.feature_base.feature_base import (
    AggregationFeature,
    DirectFeature,
    Feature,
    FeatureBase,
...
from core.featuretools.utils.gen_utils import check_schema_version
from core.featuretools.utils.s3_utils import (
    get_transport_params,
    use_smartopen_features
)
from core.featuretools.utils.wrangle import _is_s3, _is_url

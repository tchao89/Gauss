...
from core.featuretools import config
from core.featuretools.feature_base import IdentityFeature
...
from core.featuretools.tests.testing_utils import check_rename
from core.featuretools.variable_types import Categorical, Datetime, Id, Numeric

...
from core.featuretools import Feature
from core.featuretools.tests.testing_utils import make_ecommerce_entityset
from core.featuretools.variable_types.variable import NaturalLanguage

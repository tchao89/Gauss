...
from core.featuretools.computational_backends.utils import (
...
from core.featuretools.feature_base import AggregationFeature, FeatureBase
from core.featuretools.utils import Trie
from core.featuretools.utils.gen_utils import (
    import_or_none,
    is_instance,
    make_tqdm_iterator
)
from core.featuretools.variable_types import NumericTimeIndex
...
def calculate_feature_matrix(features, entityset=None, cutoff_time=None, instance_ids=None,
    ...
    from core.featuretools.entityset.entityset import EntitySet
